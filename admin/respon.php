	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn blue modal-trigger" href="#more?id_tanggapan=<?php echo $r['id_tanggapan'] ?>"><b>Lihat</a></b> <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Ya/Tidak')" href="index.php?p=tanggapan_hapus&id_tanggapan=<?php echo $r['id_tanggapan'] ?>"><b>Hapus</a></b></td>
