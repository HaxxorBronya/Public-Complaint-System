	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn teal modal-trigger" href="#regis_edit?nik=<?php echo $r['nik'] ?>"><b>Edit</a></b> <a onclick="return confirm('Anda Yakin Ingin Menghapus Ya/Tidak')" class="btn red" href="index.php?p=regis_hapus&nik=<?php echo $r['nik'] ?>"><b>Hapus</a></b></td>
