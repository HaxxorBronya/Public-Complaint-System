	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn modal-trigger blue" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>"><b>Lihat</a></b>  <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Ya/Tidak')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>"><b>Hapus</a></td></b>
