<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(../img/bgg.jpg); background-size: cover;">
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
					  ...
					  <a href=""><img class="circle"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRVDKCAN0SUMSOe95s_RLg5WcIvvsxuTlGUKMiLX9TDdlYUHvWT87t8OUJQIXeq8edhoU&usqp=CAU"></a>
                      <a href="" style="text-align: top-center;"> <span class="white-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a>
                  </div>
              </li>
