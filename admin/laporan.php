        <div class="row">
          <div class="col s12 m9">
            <h3 class="black-text"style="text-align:center"><b>Cetak Laporan</h3></b>
          </div> 
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn blue modal-trigger" href="#laporan?id_tanggapan=<?php echo $r['id_tanggapan'] ?>"><b>Lihat</a></b></td>
