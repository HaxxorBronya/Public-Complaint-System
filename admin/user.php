	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn teal modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>"><b>Edit</a></b> <a class="red btn" onclick="return confirm('Anda Yakin Ingin Menghapus Ya/Tidak')" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>"><b>Hapus</a></b></td>
