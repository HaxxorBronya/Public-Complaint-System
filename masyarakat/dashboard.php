<table class="responsive-table" border="2" style="width: 100%;">
	<tr>
		<td><h4 class="white-text hide-on-med-and-down"style="text-align : center"> <b> Tulis Laporan</h4></td></b>
		<td><h4 class="white-text hide-on-med-and-down" style="text-align : center"> <b>Daftar Laporan</h4></td></b>
	</tr>
	<tr>
		<td style="padding: 20px;">
			<form method="POST" enctype="multipart/form-data">
				<textarea class="white-textarea" name="laporan" placeholder="Tulis Laporan"></textarea><br><br>
